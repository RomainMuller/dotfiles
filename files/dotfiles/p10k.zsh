# Generated by Powerlevel10k configuration wizard on 2025-07-28 at 11:11 CEST.
...
() {
  ...
  function jj_status() {
    ...
    res+=" ${red}${VCS_STATUS_CHANGE[1]}${blue}${VCS_STATUS_CHANGE[2]}"
  ...
  function prompt_jj() {
    ...
    p10k segment -i $'\uE702' -b yellow -f black -c '$p10k_jj_status_stale'   -e -t '$p10k_jj_status'
    p10k segment -i $'\uE702' -b green  -f black -c '$p10k_jj_status_updated' -e -t '$p10k_jj_status'
